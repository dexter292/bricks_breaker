...
- `.planning/phases/01-foundation-thread-boundary-spike/01-CONTEXT.md` — Pixel 6a reference (D-01); UI-thread worklet topology
- `.planning/phases/02-headless-core-simulation/02-CONTEXT.md` — Event ring; VFX consumes events in Phase 7
- `.planning/phases/03-first-playable-render-input-bricks-lives-pause/03-CONTEXT.md` — Flat navy + row colors; immediate-mode SkPicture; neon deferred here
- `.planning/phases/04-level-format-brick-types/04-CONTEXT.md` — Neon glow/particles deferred to Phase 7
- `.planning/phases/05-run-rules-score-combo-power-ups-anti-stall/05-CONTEXT.md` — Flat pickups; neon/audio deferred
- `.planning/phases/06-ui-shell-hud-persistence-platform-seams/06-CONTEXT.md` — Services pattern; VFX/audio owned by Phase 7
