...
- `.planning/phases/02-headless-core-simulation/02-CONTEXT.md` — D-10 multi-HP/unbreakable API; D-11 level format deferred; SoA brick fields
- `.planning/phases/03-first-playable-render-input-bricks-lives-pause/03-CONTEXT.md` — D-02 color-only HP in P3; D-18 win ignores unbreakable; D-20 hardcoded grid replaced this phase
- `.planning/phases/03-first-playable-render-input-bricks-lives-pause/03-UI-SPEC.md` — Row brick palette (keep color family; add non-color cracks)
