...
- `.planning/phases/02-headless-core-simulation/02-CONTEXT.md` — D-07 N-ball pool; D-08 event ring; D-09 effects reserve; D-13 dual PRNG
- `.planning/phases/03-first-playable-render-input-bricks-lives-pause/03-CONTEXT.md` — lives/win/lose; pause freeze; SharedValue chrome mirrors
- `.planning/phases/04-level-format-brick-types/04-CONTEXT.md` — levels pipeline (drops attach to BREAK events)
