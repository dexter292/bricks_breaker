...
- `.planning/phases/01-foundation-thread-boundary-spike/01-CONTEXT.md` — D-11…D-14 layer/hot-path; opaque SkPicture; no `runOnJS` on hot path
- `.planning/phases/02-headless-core-simulation/02-CONTEXT.md` — World SoA, swept collision, paddle bounce, multi-HP/unbreakable API, event ring, determinism
