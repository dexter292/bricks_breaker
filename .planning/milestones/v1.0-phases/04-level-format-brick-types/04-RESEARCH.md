...
- `.planning/milestones/v1.0-phases/04-level-format-brick-types/04-CONTEXT.md` — locked decisions D-01…D-15
...
- `.planning/milestones/v1.0-phases/03-…/03-UI-SPEC.md` — brick palette tokens
