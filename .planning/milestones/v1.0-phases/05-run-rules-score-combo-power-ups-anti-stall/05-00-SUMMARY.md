...
key-files:
  ...
  modified:
    ...
    - .planning/milestones/v1.0-phases/05-run-rules-score-combo-power-ups-anti-stall/05-VALIDATION.md
...
- `.planning/milestones/v1.0-phases/05-run-rules-score-combo-power-ups-anti-stall/05-VALIDATION.md` — Wave 0 complete
