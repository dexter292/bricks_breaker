...
- `.planning/milestones/v1.0-phases/03-first-playable-render-input-bricks-lives-pause/03-CONTEXT.md` — pause/AppState/countdown; minimal overlays; gesture/UI separation; letterbox
- `.planning/milestones/v1.0-phases/05-run-rules-score-combo-power-ups-anti-stall/05-CONTEXT.md` — Score/combo/Stall SharedValue chrome; Phase 6 owns polish + persistence
- `.planning/milestones/v1.0-phases/05-run-rules-score-combo-power-ups-anti-stall/05-REVIEW-FIX.md` — Stall chrome gated to PLAYING; win-before-lives
