...
**Last updated:** 2026-09-22 (RE-AUDIT-07: F-43 component-contract via RN-web; store email still blocks submit)
...
| **Store email** | App Store / Play support contact email | NJ-3 / NK-7 / store submit | Owner before App Store submit | **DEFERRED — blocks submit** | Privacy Contact primary is GitHub Discussions (working). Do **not** invent a personal email. A real support inbox is still required before store submit (**NJ-3**). |
