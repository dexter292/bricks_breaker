...
| **WP-6** | Device certification rows | Phase 8 / post-MVP A1 | Hardware gate | **PARTIAL** | iOS D-16 = observation; ceiling/floor **NOT RUN**. Physical soak **PASS** (dev-client 2026-09-24). Android **OUT OF SCOPE (D2=B)** |
